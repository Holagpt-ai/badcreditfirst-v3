      ...
      <main className="flex-1">
        ...
        <section className="max-w-5xl mx-auto px-6 pb-12" aria-labelledby="top-picks">
          ...
          <details className="mb-4 group">
            <summary className="text-xs text-slate-400 cursor-pointer hover:text-slate-600 transition-colors list-none flex items-center gap-1 w-fit">
            ...
            <p className="mt-2 text-xs text-slate-500 leading-relaxed max-w-2xl">
              We may receive compensation when you apply through our links. Our editorial content and product rankings are independent and not influenced by compensation.{' '}
